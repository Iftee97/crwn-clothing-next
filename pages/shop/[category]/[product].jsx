...
export default function SingleProduct({ product }) {
  ...
  return (
    <>
      <Head>
        <title>{product ? `${product.title} | Crwn Clothing` : "Product | Crwn Clothing"}</title>
      </Head>
      <div className="max-w-[768px] mx-auto">
        {productNotFound ? (
          <div className="flex flex-col items-center justify-center min-h-[75vh]">
            <p className="text-2xl">Product not found</p>
            <Link href="/shop" className="border border-neutral-900 py-2 px-3 rounded bg-white text-black hover:bg-gray-100 mt-4 cursor-pointer">
              Go To Shop
            </Link>
          </div>
        ) : (
          <div className="flex flex-col lg:flex-row items-start justify-center gap-10 mb-6">
            ...
            <div className="flex flex-col lg:flex-1 gap-2 lg:gap-4">
              <h2 className="text-[36px] text-center font-semibold">{product.title}</h2>
              <p className="leading-7 mb-2">{product.description}</p>
              <div className="flex items-center justify-between">
                <p className="text-[22px] lg:text-[24px]">Price: ${product.price}</p>
                <div className="flex items-center gap-2">
                  <button className="cursor-pointer" onClick={decreaseQty}>
                    <HiOutlineMinus className="text-2xl" />
                  </button>
