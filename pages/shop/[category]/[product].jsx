...
//         `/api/products/get-product-by-title?title=${title}`
//       );
...
//     content = <h2 className="text-2xl font-medium">No product found.</h2>;
//   }
//   if (!productLoading && product) {
//     content = (
...
export async function getStaticPaths() {
  ...
  // const res = await fetch(
  //   `${process.env.NEXT_PUBLIC_API_URL}/categories/get-category-by-title/${title}`
  // );
}
